    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emotions', models.CharField(blank=True, max_length=300)),
                ('summary', models.CharField(blank=True, max_length=200)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_use_comment', models.BooleanField()),
                ('is_save_video', models.BooleanField()),
                ('csv_url', models.CharField(blank=True, max_length=200)),
